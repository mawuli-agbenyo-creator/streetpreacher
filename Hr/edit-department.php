...
if (isset($_GET['id'])) {
  ...
  // Fetch the existing department details
  try {
    $stmt = $dbh->prepare("SELECT * FROM departments WHERE id = :id");
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  if (!empty($department_name)) {
    try {
      $stmt = $dbh->prepare("UPDATE departments SET name = :name WHERE id = :id");
...
<head>
  ...
  <title>Edit Department | <?php echo $sitename; ?></title>
              ...
              <form method="POST" action="">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="departmentName" name="department_name" placeholder="Enter department name" value="<?php echo htmlspecialchars($department['name']); ?>" required>
                  </div>
                </div>
