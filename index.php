                ...
                <ul class="navbar-nav ml-auto navbar-center" id="mySidenav">
                    <li class="nav-item active">
                        <a href="#home" class="nav-link">Home</a>
                                   ...
                                   <li class="nav-item">
                        <a href="Hr/index.php" class="nav-link">Hr Dashboard</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="hero-title">
                    <h1 class="hero-7-title">
                        <span class="text-wrapper">
                            <span class="text-light font-weight-normal">HR Management System </span>                        </span>                    </h1>
                    <p class="text-light-70 mb-4 pb-2">
                    HR management is the process by which employers ensure workers perform their jobs to the 
            ...
            <div class="col-lg-5 offset-lg-1">
                <div class="hero-login-form mx-auto p-4 rounded mt-5 mt-lg-0 bg-white">
                    <div class="text-center">
                        <h5 class="form-title mb-4"></h5>HR SYSTEM
                    </div>
